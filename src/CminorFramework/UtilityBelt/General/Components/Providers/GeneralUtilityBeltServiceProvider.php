...
class GeneralUtilityBeltServiceProvider extends Container implements IGeneralUtilityBeltServiceProvider
{
    ...
    public function __construct()
    {
        ...
        $this->bind('CminorFramework\UtilityBelt\General\Contracts\Html\IHtmlWrapper', 'CminorFramework\UtilityBelt\General\Components\Html\HtmlWrapper', false);
        ...
        $this->bind('CminorFramework\UtilityBelt\General\Contracts\UserAgent\IUserAgentHelper', '\CminorFramework\UtilityBelt\General\Components\UserAgent\UserAgentHelper', true);
    }
